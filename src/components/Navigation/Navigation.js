    ...
    if (props.route === "signIn") {
        return (
            <nav className="nav">
                ...
                <Link onClick={() => props.onRouteChange("signUp")} className="link2" text="Sign Up"/>
            </nav>
        );
    } else if (props.route === "signUp") {
        return (
            <nav className="nav">
                <Link onClick={() => props.onRouteChange("signIn")} className="link2" text="Sign In"/>
        ...
        return (
            <nav className="nav">
                ...
                <Link onClick={() => props.onRouteChange("profile")} className="link2" text="Profile"/>
                <Link onClick={() => props.onRouteChange("signOut")} className="link2" text="Sign Out"/>
            </nav>
        );
    } else if (props.route === "profile") {
        return (
            <nav className="nav">
                <Link onClick={() => props.onRouteChange("home")} className="link2" text="Home"/>
